...
public class KidneyDiseaseCheckActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    int totalQuestion = QuizKidneyDiseaseClass.question.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kidney_disease_checkup);
        ...
        btn_restart.setBackground(ContextCompat.getDrawable(KidneyDiseaseCheckActivity.this, R.drawable.round_layout));
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                KidneyDiseaseCheckActivity.super.onBackPressed();
            }
        });
        ...
        SeeResults.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(KidneyDiseaseCheckActivity.this, MainActivity.class);
    ...
    void loadNewQuestion() {
        ...
        questionTextView.setText(QuizKidneyDiseaseClass.question[currentQuestionIndex]);
        ansA.setText(QuizKidneyDiseaseClass.choices[currentQuestionIndex][0]);
