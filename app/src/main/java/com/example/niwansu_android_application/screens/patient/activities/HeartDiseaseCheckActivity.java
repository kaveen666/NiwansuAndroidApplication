...
import com.example.niwansu_android_application.core.QuizHeartDiseaseClass;

import java.text.SimpleDateFormat;
import java.util.Date;
import java.util.Locale;

public class HeartDiseaseCheckActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    int totalQuestion = QuizHeartDiseaseClass.question.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_heartdisease_checkup);
        ...
        btn_restart.setBackground(ContextCompat.getDrawable(HeartDiseaseCheckActivity.this, R.drawable.round_layout));
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                HeartDiseaseCheckActivity.super.onBackPressed();
            }
        });
        ...
        SeeResults.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HeartDiseaseCheckActivity.this, MainActivity.class);
    ...
    public void onClick(View view) {
        ...
        if (clickedButton.getId() == R.id.submit_btn) {
                ...
                if (selectedAnswer.equals(QuizHeartDiseaseClass.Answer1[currentQuestionIndex])) {
                    score = new Integer(score + 0);
                    currentQuestionIndex++;
                    loadNewQuestion();
                } else if (selectedAnswer.equals(QuizHeartDiseaseClass.Answer2[currentQuestionIndex])) {
                    score = new Integer(score + 1);
                    currentQuestionIndex++;
                    loadNewQuestion();
                } else if (selectedAnswer.equals(QuizHeartDiseaseClass.Answer3[currentQuestionIndex])) {
                    score = new Integer(score + 2);
                    currentQuestionIndex++;
                    loadNewQuestion();
                } else if (selectedAnswer.equals(QuizHeartDiseaseClass.Answer4[currentQuestionIndex])) {
                    score = new Integer(score + 3);
                    currentQuestionIndex++;
                    loadNewQuestion();
                } else if (selectedAnswer.equals("")) {
                    Toast.makeText(HeartDiseaseCheckActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
    ...
    void loadNewQuestion() {
        ...
        questionTextView.setText(QuizHeartDiseaseClass.question[currentQuestionIndex]);
        ansA.setText(QuizHeartDiseaseClass.choices[currentQuestionIndex][0]);
